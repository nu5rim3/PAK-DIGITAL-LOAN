...
// APIs
import {
    getTermDepositReport
} from "services/report.service";



const TermDepositReport = (props) => {
    ...
    const exportToExcel = async () => {
        ...
        const response = await getTermDepositReport(exportData)

        const blob = new Blob([response.data], { type: 'application/vnd.openxmlformats-officedocument.spreadsheetml.sheet' });
        const link = document.createElement('a');
        link.href = window.URL.createObjectURL(blob);
        link.download = `term-deposit-report.xlsx`;
        link.click();
    }
            ...
            <div className="page-content">
                <Container fluid>
                    ...
                    <Breadcrumbs
                        ...
                        breadcrumbItem={"Term Deposit Report"}
                    />
                    ...
                    <Row>
                        <Col className="col-12">
                            <Card>
                                <CardBody>
                                    <CardTitle className="h4">Term Deposit Report</CardTitle>
...
TermDepositReport.propTypes = {
    t: PropTypes.any,
};

export default TermDepositReport;