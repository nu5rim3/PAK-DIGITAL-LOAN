...
const BiReport = (props) => {
    ...
    const exportToExcel = async () => {
        ...
        const response = await getBusinessIntroducerReport(exportData)

        const blob = new Blob([response.data], { type: 'application/vnd.openxmlformats-officedocument.spreadsheetml.sheet' });
        const link = document.createElement('a');
        link.href = window.URL.createObjectURL(blob);
        link.download = `business-introducer-report.xlsx`;
        link.click();
    }
            ...
            <div className="page-content">
                <Container fluid>
                    ...
                    <Breadcrumbs
                        ...
                        breadcrumbItem={"Business Introducer Report"}
                    />
                    ...
                    <Row>
                        <Col className="col-12">
                            <Card>
                                <CardBody>
                                    <CardTitle className="h4">Business Introducer Report</CardTitle>
