...
const CommonOauth2Logout = () => {
    ...
    useEffect(async () => {
        ...
        if (_isMounted) {
            window.location.replace(`${process.env.REACT_APP_IDENTITY_SERVER_URL}/commonauth?commonAuthLogout=true&type=oidc&commonAuthCallerPath=${process.env.REACT_APP_COMMON_OAUTH_URL}`)
        }
